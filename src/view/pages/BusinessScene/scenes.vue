          ...
          <el-col :span="22" :offset="1">
            <div class="grid-content">
              <el-row class="selecTitle">
                <el-col :span="6" :offset="0">业务模式：</el-col>
              </el-row>
              <!--查询  -->
              <div>
                ...
                <el-button class="selectButton" size="medium" type="primary" @click="addScence()">新 建</el-button>
              </div>
            </div>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="22" :offset="1">
            ...
            <el-table :data="tableData" height="330">
              ...
              <el-table-column  prop="Number" label="场景名称"  align="center"></el-table-column>
              <el-table-column  prop="VideoTitle" label="创建时间"  align="center"></el-table-column>
              ...
              <el-table-column prop="currentOperator" label="难度" filter-placement="bottom-end"  align="center"></el-table-column>
...
export default {
      ...
      tableData: [
        {
          ...
          UMID: '车险营销',
          Number: '开场白',
          VideoTitle: '2018-10-18 08:42:50',
          updateTime: '2018-12-18 08:42:50',
          currentOperator: '中'
        },
        {
          className: '2',
  ...
  methods: {
    ...
    handleEdit(rows){
      console.log(rows)
      this.$router.push({name: 'ScenceBg',query: { className:rows.className}})
    },
    addScence(){
...
@import '../../../assets/theme/pageStyle/scenes';
</style>

<template>
  <div class="recordingmaterial">
    <el-row>
          <el-col :span="22" :offset="1">
            <div class="grid-content">
              <el-row class="selecTitle">
                <el-col :span="6" :offset="0">业务模式：</el-col> <el-col :span="6" :offset="0">环节:</el-col>
              </el-row>
              <!--查询  -->
              <div>
                ...
                <el-button class="selectButton" size="medium" type="primary" @click="addVideo()">新 建</el-button>
              </div>
            </div>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="22" :offset="1">
            ...
            <el-table :data="tableData" height="330">
              ...
              <el-table-column  prop="UMID" label="标题"  align="center"></el-table-column>
              <el-table-column  prop="Number" label="环节"  align="center"></el-table-column>
              <el-table-column  prop="VideoTitle" label="上传时间"  align="center"></el-table-column>
...
@import '../../../assets/theme/pageStyle/recordingmaterial';
</style>
